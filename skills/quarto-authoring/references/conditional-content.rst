...
Quarto allows content to be shown or hidden based on output format,
metadata, or profiles.
...
Quarto creates a JSON file with execution context information. Read it
to conditionally execute code in any language.
...
See
`QUARTO_EXECUTE_INFO <https://quarto.org/docs/advanced/quarto-execute-info.html>`__
...
- `Quarto Conditional
  Content <https://quarto.org/docs/authoring/conditional.html>`__
- `Project Profiles <https://quarto.org/docs/projects/profiles.html>`__
