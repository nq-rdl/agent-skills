...
Quarto provides comprehensive support for figures including sizing,
layout, subfigures, and accessibility features.
...
+----------------------+----------------+---------------------------------+
| ``fig-width``        | Width in       | ``8``                           |
|                      | inches         |                                 |
+----------------------+----------------+---------------------------------+
| ``fig-height``       | Height in      | ``6``                           |
|                      | inches         |                                 |
+----------------------+----------------+---------------------------------+
| ``fig-align``        | Alignment      | ``"center"``                    |
+----------------------+----------------+---------------------------------+
| ``fig-cap-location`` | Caption        | ``"bottom"``, ``"top"``,        |
|                      | position       | ``"margin"``                    |
+----------------------+----------------+---------------------------------+
...
- `Lightbox <https://quarto.org/docs/output-formats/html-lightbox-figures.html>`__
