...
Supported types: ``thm``, ``lem``, ``cor``, ``prp``, ``cnj``, ``def``,
``exm``, ``exr``.
...
- `Quarto Books <https://quarto.org/docs/books/>`__
- `Cross-References <https://quarto.org/docs/authoring/cross-references.html>`__
- `Theorems <https://quarto.org/docs/authoring/cross-references.html#theorems-and-proofs>`__
