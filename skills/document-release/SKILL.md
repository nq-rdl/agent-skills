...
description: >-
  ...
  TODOS, and VERSION are accurate and up to date. Trigger phrases: "update the
  docs to match what shipped", "docs are stale after my changes", "README is
...
- Context: current branch and which doc file is under review
- The specific documentation decision, explained in plain English
- `RECOMMENDATION: Choose [X] because [one-line reason]`
- Lettered options, always including a "Skip — leave as-is" option
...
**If CHANGELOG was not modified in this branch (and no unreleased fragments were modified):**
skip this step.
...
3. **If VERSION was NOT bumped:** Use AskUserQuestion with:
   - Context: current branch and current VERSION value
...
- Already bumped — version was already set
