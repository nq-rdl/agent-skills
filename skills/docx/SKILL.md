...
- **pandoc**: Text extraction (install via system package manager)
- **defusedxml, lxml**: XML validation (install via `ensure-deps.sh`)
- **docx**: `npm install -g docx` (new documents — system-level JS tool)
- **LibreOffice**: PDF conversion and accepting tracked changes
