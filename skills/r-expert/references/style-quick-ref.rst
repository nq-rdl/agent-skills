...
Condensed from the `Tidyverse Style
Guide <https://style.tidyverse.org/>`__ and `Google R Style
Guide <https://google.github.io/styleguide/Rguide.html>`__.
...
|                     |                          | ``fit_model``         |
+---------------------+--------------------------+-----------------------+
| Functions           | snake_case (verbs)       | ``compute_mean()``,   |
|                     |                          | ``validate_input()``  |
+---------------------+--------------------------+-----------------------+
