...
VHS records terminal sessions from tape scripts for visual regression and documentation.
...
For visual regression, diff GIFs are not practical — instead, record text output:
