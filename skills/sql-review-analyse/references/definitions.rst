...
Reference them — do not improvise your own wording during a walkthrough. Each
suite skill ships an **identical copy** of this file in its own ``references/``
so it stays self-contained; keep the copies in sync and do not let them drift.
They may still evolve (the ``Limitation`` definition is being finalised in
governance issue #105).
