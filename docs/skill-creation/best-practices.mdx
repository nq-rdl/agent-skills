...
- **Reference examples** for hook authoring (like `cc-hooks/examples/`) are fine — they're documentation teaching users how to write hooks, not active hook registrations
